...
var TechRegistry = []TechDefinition{
	...
	{ID: "mediaconnect", Name: "AWS Elemental MediaConnect", Type: "app", Emoji: "📡", Matches: []string{"mediaconnect"}},
	{ID: "medialive", Name: "AWS Elemental MediaLive", Type: "app", Emoji: "🎥", Matches: []string{"medialive"}},
	{ID: "mediapackage", Name: "AWS Elemental MediaPackage", Type: "app", Emoji: "📦", Matches: []string{"mediapackage"}},
	{ID: "lambda", Name: "AWS Lambda", Type: "app", Emoji: "⚡", Matches: []string{"lambda"}},
	{ID: "fargate", Name: "AWS Fargate", Type: "app", Emoji: "🐳", Matches: []string{"fargate", "ecs"}},
	{ID: "bedrock", Name: "Amazon Bedrock", Type: "app", Emoji: "🧠", Matches: []string{"bedrock"}},
	{ID: "transcribe", Name: "Amazon Transcribe", Type: "app", Emoji: "🎙️", Matches: []string{"transcribe"}},
	{ID: "apigateway", Name: "Amazon API Gateway", Type: "gateway", Emoji: "🌐", Matches: []string{"apigateway", "api_gateway", "api-gateway"}},
	{ID: "cloudfront", Name: "Amazon CloudFront", Type: "gateway", Emoji: "🌐", Matches: []string{"cloudfront"}},
